...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/odc-io-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14135&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/odc-io-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `odc-io` can be installed with:

```
conda install odc-io
```

It is possible to list all of the versions of `odc-io` available on your platform with:
